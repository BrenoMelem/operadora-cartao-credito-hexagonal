...
public class GeraDadosCartaoService {
        ...
        public CartaoDomain gerarParaCliente(ClienteDomain cliente) {
            ...
            return new CartaoDomain(numeroCartao, dataExpiracao, cvv, limiteCredito,cliente, cliente.getCartao().getUltimaAlteracaoLimite(),cliente .getCartao().getDataVencimentoFatura());
        }
